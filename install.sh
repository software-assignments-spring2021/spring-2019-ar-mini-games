...
curl --retry 5 -o Unity.pkg https://download.unity3d.com/download_unity/a220877bc173/UnityDownloadAssistant.dmg
...
# curl --retry 5 -o Unity_win.pkg https://download.unity3d.com/download_unity/a220877bc173/UnityDownloadAssistant.dmg
# if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
